...
function Navbar() {
  ...
  return (
    <div className="py-2 px-4 bg-white shadow-md flex justify-between items-center top-0 z-50 sticky">
      ...
      <div className="flex items-center gap-4">
        ...
        <Image
          className="w-[44px] rounded-full shadow-md shadow-black"
        ...
        <button
          onClick={signOut}
          title="Sign out"
          className="shadow-md bg-transparent transition-all duration-500 active:duration-100 shadow-black hover:shadow-lg hover:shadow-black hover:scale-110 active:shadow-md active:shadow-black active:scale-90 rounded-2xl px-3 py-2"
        >
          SignOut
        </button>
      </div>
